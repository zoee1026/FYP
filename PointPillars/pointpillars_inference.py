...
def generate_config_from_cmd_args():
    ...
    parser.add_argument('--occ_thresh', default=0.5, type=float, required=False,
                        help='Occlusion threshold for predicted boxes')
    parser.add_argument('--nms_thresh', default=0.7, type=float, required=False,
